        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    GovName = table.Column<string>(maxLength: 50, nullable: false),
                    DateJoined = table.Column<string>(type: "varchar(10)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    BlogAppUserId = table.Column<string>(type: "varchar(80)", nullable: false),
                    AuthorName = table.Column<string>(nullable: false),
                    Title = table.Column<string>(maxLength: 200, nullable: false),
                    Summary = table.Column<string>(maxLength: 400, nullable: false),
                    DatePosted = table.Column<string>(type: "varchar(10)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    CommentId = table.Column<int>(nullable: false)
                        .Annotation("MySql:ValueGenerationStrategy", MySqlValueGenerationStrategy.IdentityColumn),
                    PostsPostId = table.Column<int>(nullable: false),
                    ...
                    DateCreated = table.Column<string>(type: "varchar(10)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    PostsPostId = table.Column<int>(nullable: false),
                    TagsTagId = table.Column<int>(nullable: false)
                },
                constraints: table =>
                {
